            ...
            children: <Widget>[
              GestureDetector(
                  ...
                  onTap: () {
                    ...
                    //   context,
                    //   MaterialPageRoute(
                    //     builder: (context) => DistrictGridPage(),
                    //   ),
                    // );

                    Navigator.of(context).popAndPushNamed(
                      AppRoutes.DISTRICTGRIDEPAGE,
                    );
                  }),
              GestureDetector(
                  child: Column(
              ...
              GestureDetector(
                  ...
                  onTap: () {
                    setState(() {
                      //Get.to(GetAreasFirsbase());

                      // Navigator.push(
                      //   context,
                      //   MaterialPageRoute(
                      //     builder: (context) => GetAreasFirsbase(),
                      //   ),
                      // );
                      Navigator.of(context)
                          .popAndPushNamed(AppRoutes.GETAREASFIREBASE);
                    });
                  }),
              GestureDetector(
                  child: Column(
                  ...
                  onTap: () {
                    setState(() {
                      ...
                      Navigator.of(context)
                          .popAndPushNamed(AppRoutes.DONATIONPAGE);
                    });
                  }),
              GestureDetector(
                  child: Column(
