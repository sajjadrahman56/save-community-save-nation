...
class GetAreasFirsbase extends StatefulWidget {
  const GetAreasFirsbase({super.key});

  @override
  State<GetAreasFirsbase> createState() => _GetAreasFirsbaseState();
}

class _GetAreasFirsbaseState extends State<GetAreasFirsbase> {
